...
<head>
    ...
    <title>Vettix - Tambah Peserta</title>
...
<div class="d-flex align-items-center mb-0">
        <div>
            <h4 class="fw-bold text-dark mb-0">Tambah Participant</h4>
            <h4 class="text-muted small mb-0" style="font-size: 15px; height: 7px;">Tambahkan peserta baru</h4>
        </div>
            ...
            <div class="col-md-8">
                <div class="card form-card p-4">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <h4 class="fw-bold mb-0">Tambah Peserta Baru</h4>
                    </div>
